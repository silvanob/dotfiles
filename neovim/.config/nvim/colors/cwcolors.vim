...
set background=dark
hi Normal               guifg=#e6e6e6 guibg=NONE guisp=#F1F1F1 gui=NONE
...
" ~ lines below text.
hi NonText	        guifg=#2f2f2f guibg=NONE guisp=#202020 gui=NONE

" The (vim) status line of the active window.
hi StatusLine           guifg=#F1F1F1 guibg=NONE guisp=#000000 gui=NONE
